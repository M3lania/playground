...
class TestHomePageErrors:
    ...
    def test_location_with_invalid_input(self, homepage_class, value):
        """
        Tests which run in the same browser session. We get speed, but lose their
        independence of each other. To get to the initial state, the Geocode menu button
        is pressed at the end of each test.
        """
